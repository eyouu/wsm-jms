package com.whosaidmeow.wsmjms.listener;
...
//        System.out.println(helloWorldMessage);
    ...
    public void listenForHello(@Payload HelloWorldMessage helloWorldMessage,
        ...
        HelloWorldMessage replyWithIt = HelloWorldMessage.builder()
                .id(UUID.randomUUID())
                .message("World!!")
                .build();

        jmsTemplate.convertAndSend(message.getJMSReplyTo(), replyWithIt);
